    ...
    <section id="about" className="py-24 relative">
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <div className="w-20 h-1 bg-gradient-to-r from-neon-cyan to-neon-blue mx-auto mb-12" />
        </motion.div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <Card className="bg-card/50 backdrop-blur-sm border-border/50 p-8 md:p-12 shadow-lg hover:shadow-xl transition-shadow">
