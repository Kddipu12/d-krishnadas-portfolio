...
export default function Skills() {
  return (
    <section id="skills" className="py-24 relative bg-gradient-to-b from-background to-background/50">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          {skillCategories.map((category, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="bg-card/50 backdrop-blur-sm border-border/50 p-6 h-full hover:shadow-xl transition-all hover:border-primary/50">
